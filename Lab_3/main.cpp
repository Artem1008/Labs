 ...
 * на тему: “ Калькулятор на QWidget, в IDE (интегрированной среде разработки) QtCreator”
 * Цель работы:
 * 1. Создать приложения Qt Widgets в Qt Creator, реализовать калькулятор.
 * 2. Операции ветвления. Выполнить преобразование типов данных. Приведение типов.
