...
//вместо печати строки раздуваем программу ещё на дополнительный класс, и всёравно надо постоянно вызывать функцию из него, при этом заменить сообщение не получится
