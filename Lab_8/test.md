...
| Можно ли добавлять новые элементы? Если да, то каким образом? С какой стороны разрешено их добавлять? | Нельзя.| Нельзя. | push_back() добавляет элемент в конец вектора, insert(n,data) добавляет элемент в произвольное местосо сдвигом |  push_back добавляет элемент в конец списка,push_front добавляет элемент в начало списка insert(n,data) добавляет элемент в произвольное местосо сдвигом | 
...
| Какими способами можно получить доступ к произвольному элементу класса? | | | | | 
| Можно ли добавлять новые элементы? Если да, то каким образом? С какой стороны разрешено их добавлять? | | | | | 
| Можно ли удалять элементы? Если да, то каким образом? С какой стороны разрешено их удалять?|  | | | | 
| Каким способом можно узнать количество элементов в классе? | | | | | 
